...
namespace com.mojang.escape.gui
{
    public class Bitmap3D : Bitmap
    {
        ...
        private void renderSprite(double x, double y, double z, int tex, int color)
        {
            ...
            int xp0 = (int)Math.Ceiling(xPixel0);
            int xp1 = (int)Math.Ceiling(xPixel1);
            int yp0 = (int)Math.Ceiling(yPixel0);
            int yp1 = (int)Math.Ceiling(yPixel1);
